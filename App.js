        ...
        <View style={styles.postContainer}>
          ...
          <View style={styles.postLike}>
            <View style={styles.postPersonThumbnail}>
              <Image  style={{ width: 21, height: 21, borderRadius: 500}} source={require('./src/assets/images/profile-4.jpg')}/>
            </View>
            <View >
              <Paragraph>Liked by 
          ...
          <View style={styles.postDescription}>
            ...
            <Text style={{ fontSize: 14, fontWeight: 'bold'}}>karennne </Text>
             The game in New York was amazing and I want to share some photos</Paragraph>
          </View>
        </View>
